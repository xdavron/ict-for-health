...
#%%plt.figure()
Lungs = filterImage(B,1)
# Lungs[Lungs==0]=np.na
plt.imshow(Lungs,interpolation="nearest")
plt.title('infection mask')
#%% Extracting feature
infected_points=0
all_points=0
...
for line in InfectionMask:
    for points in line:
        if points == 1:
            infected_points+=1
print(infected_points)
ration = infected_points/all_points
if ration>0.03:
    print('Ground glass opacity is high')
else:
    print('Ground glass opacity is low')